                ...
                <div className="relative max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 md:gap-8 relative z-20">
                        ...
                        <div className={`relative transition-all duration-700 ${scrollProgress >= 5 ? 'opacity-100 transform translate-y-0' : 'opacity-70 transform translate-y-4'}`}>
                            {/* Card */}
                            <div className="bg-white/90 backdrop-blur-sm rounded-xl p-4 md:p-6 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 relative group mt-16 h-56 sm:h-60 md:h-64 w-full flex flex-col">
                                ...
                                <div className="flex flex-col items-center text-center pt-6 flex-1 justify-center">
                                    <div className="mb-4 p-3 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl group-hover:from-blue-100 group-hover:to-indigo-100 transition-all duration-300">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#3a86ff] group-hover:text-[#0a1e42] transition-colors duration-300">
                                            <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
                                            <circle cx="12" cy="7" r="4"></circle>
                                        </svg>
                                    </div>
                                    <h3 className="text-[#0a1e42] font-bold mb-2 text-lg">Sign Up</h3>
                                    <p className="text-gray-600 text-sm leading-relaxed">Register as an Innovator</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className={`relative transition-all duration-700 delay-150 ${scrollProgress >= 20 ? 'opacity-100 transform translate-y-0' : 'opacity-70 transform translate-y-4'}`}>
                            <div className="bg-white/90 backdrop-blur-sm rounded-xl p-4 md:p-6 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 relative group mt-16 h-56 sm:h-60 md:h-64 w-full flex flex-col">
                                ...
                                <div className="flex flex-col items-center text-center pt-6 flex-1 justify-center">
                                    ...
                                    <h3 className="text-[#0a1e42] font-bold mb-2 text-lg">Join</h3>
                                    <p className="text-gray-600 text-sm leading-relaxed">Start with an Idea Board to design ODR</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className={`relative transition-all duration-700 delay-500 ${scrollProgress >= 60 ? 'opacity-100 transform translate-y-0' : 'opacity-70 transform translate-y-4'}`}>
                            <div className="bg-white/90 backdrop-blur-sm rounded-xl p-4 md:p-6 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 relative group mt-16 h-56 sm:h-60 md:h-64 w-full flex flex-col">
                                ...
                                <div className="flex flex-col items-center text-center pt-6 flex-1 justify-center">
                                    ...
                                    <h3 className="text-[#0a1e42] font-bold mb-2 text-lg">Connect</h3>
                                    <p className="text-gray-600 text-sm leading-relaxed">Engage with mentors and the AI chatbot</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className={`relative transition-all duration-700 delay-700 ${scrollProgress >= 80 ? 'opacity-100 transform translate-y-0' : 'opacity-70 transform translate-y-4'}`}>
                            <div className="bg-white/90 backdrop-blur-sm rounded-xl p-4 md:p-6 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 relative group mt-16 h-56 sm:h-60 md:h-64 w-full flex flex-col">
                                ...
                                <div className="flex flex-col items-center text-center pt-6 flex-1 justify-center">
                                    ...
                                    <h3 className="text-[#0a1e42] font-bold mb-2 text-lg">Reflect</h3>
                                    <p className="text-gray-600 text-sm leading-relaxed">Collaboratively develop Impactful ODR Systems</p>
                                </div>
                            </div>
                        </div>
                    </div>
